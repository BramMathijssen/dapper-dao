export const DaoAbi = [
    ...
    { type: "function", name: "getMember", constant: true, stateMutability: "view", payable: false, gas: 29000000, inputs: [{ type: "address", name: "_memberAddress" }], outputs: [{ type: "address" }, { type: "bool" }, { type: "bytes32" }, { type: "uint256" }] },
    { type: "function", name: "getMembers", constant: true, stateMutability: "view", payable: false, gas: 29000000, inputs: [], outputs: [{ type: "address[]" }, { type: "bool[]" }, { type: "bytes32[]" }, { type: "uint256[]" }] },
    { type: "function", name: "getMembersList", constant: true, stateMutability: "view", payable: false, gas: 29000000, inputs: [], outputs: [{ type: "address[]" }] },
    {
        type: "function",
        name: "members",
        constant: true,
